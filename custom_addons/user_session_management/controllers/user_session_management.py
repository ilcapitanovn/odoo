    ...
    def web_login(self, redirect=None, **kw):
        ...
        if request.params['login_success']:
            try:
                ...
                _logger.exception("user_session_management.user_session_management.web_login - Exception: %s" % e)
        return res
    ...
    def logout(self, redirect='/web', uid=False, usm_session_id=False):
        ...
        if user:
            try:
                ...
                # Ignore logging if transaction blocked error occurred
                _logger.exception("user_session_management.user_session_management.logout - Exception: %s" % e)
